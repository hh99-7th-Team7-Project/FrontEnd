...
const BoardDetail = () => {
  ...
  return (
      ...
      <ScWrap>
        <BoardMain head ={boardReducer} boardId={boardId}
         bookmark2={bookmark} setBookmark={setBookmark}/>
        <BoardContent data={content}/>
        <BoardLike head ={boardReducer}  boardId={boardId}
         like2={like} setLike={setLike}/>
        <BoardComment/>
      </ScWrap>
     </>
  )
